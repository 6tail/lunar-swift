...
public class TaoUtil {
    ...
    public static var SAN_YUAN: [String] = ["1-15", "7-15", "10-15"]
    public static var WU_LA: [String] = ["1-1", "5-5", "7-7", "10-1", "12-8"]
    public static var AN_WU: [String] = ["未", "戌", "辰", "寅", "午", "子", "酉", "申", "巳", "亥", "卯", "丑"]
    public static var BA_HUI: [String: String] = [
        "丙午": "天会",
        "壬午": "地会",
        "壬子": "人会",
        "庚午": "日会",
    ...
    public static var BA_JIE: [String: String] = [
